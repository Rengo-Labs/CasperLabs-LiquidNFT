...
class CEP47Client {
  ...
  public async mint(
    ...
    //const _recipient = new CLByteArray(Uint8Array.from(Buffer.from(recipient, 'hex')));
    const runtimeArgs = RuntimeArgs.fromMap({
...
//   let deploy = DeployUtil.makeDeploy(
//     new DeployUtil.DeployParams(keys.publicKey, chainName, 1), //ttl inside DeployParams
